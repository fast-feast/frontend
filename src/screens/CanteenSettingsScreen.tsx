...
export default function CanteenSettingsScreen() {
  ...
  const [form, setForm] = useState<FormFields>({
    name: canteen?.name || '',
    description: (canteen?.description as string) || '',
    contactPhone: (canteen?.contactPhone as string) || '',
    address: (canteen?.address as string) || '',
    openingHours: (canteen?.openingHours as string) || '',
    avgWaitTime: canteen?.avgWaitTime || '',
    rushLevel: canteen?.rushLevel || 'low',
    bannerImage: canteen?.bannerImage || '',
    logoImage: (canteen?.logoImage as string) || '',
